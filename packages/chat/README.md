...
Requires **Bun** for hashing, `./sqlite`, and `./http/server`. Browsers should import `@khoralabs/chat/http/client` and `@khoralabs/chat/sources` instead of the package root or a fat HTTP barrel. Use `./turso-serverless` for Turso/libSQL-style SQL.
